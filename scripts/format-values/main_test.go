...
func TestDo(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{
			...
			args: args{
				reader:       strings.NewReader(V1_7_1_CONTENT),
				chartVersion: "v1.7.1",
			},
			wantW1:  "",
			wantW2:  "",
		...
		},
		{
			...
			args: args{
				reader:       strings.NewReader(V1_8_0_CONTENT),
				chartVersion: "v1.8.0",
			},
			wantW1:  "",
			wantW2:  "",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			w1 := &bytes.Buffer{}
			w2 := &bytes.Buffer{}
			err := Do(tt.args.reader, tt.args.chartVersion, w1, w2)
			...
			if gotW2 := w2.String(); gotW2 != tt.wantW2 {
				t.Errorf("Do() gotW2 = %v, want %v", gotW2, tt.wantW2)
			}
		})
	}
}
